								...
								<center><h4>Bienvenido "Administrador"</h4><center>
									...
									<div class="6u 12u$(medium)">
										<ul class="actions vertical">
											<li><a href="#" class="button special fit">Altas</a></li>
											<li><a href="#" class="button fit">Bajas</a></li>
											<li><a href="#" class="button special fit">Cambios</a></li>
											<li><a href="#" class="button fit">Consultas</a></li>
										</ul>
									</div>
